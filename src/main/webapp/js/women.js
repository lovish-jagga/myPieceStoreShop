...
class ProductList {
  products = [
    new Product(
      'White top',
      './Image/women__product1.jpg',
      'Contrasting white sleeveless top',
      54.08
    ),
    new Product(
      'A antique dress',
      './Image/women__product2.jpg',
      'Tropical Kimono',
      61
    ),
    new Product(
      'Cotton T-shirt',
      './Image/women__product3.jpg',
      'A very soft cotton dress',
      32
),
    new Product(
      'A lemon trouser',
      './Image/women__product4.jpg',
      'Water Resistant',
      22.29
)
  ];
